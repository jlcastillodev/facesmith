  ...
  >
    ...
    <div className="relative">
      <img
        ...
        className="mx-auto aspect-square rounded-lg border border-slate-100 object-cover shadow-inner dark:border-slate-800"
        loading="lazy"
      />
      {loading ? (
    ...
    <div className="space-y-2">
      ...
      {flaggedTerms.length > 0 && (
        <p className="text-xs text-amber-600 dark:text-amber-400">
          Blocked terms removed: {flaggedTerms.join(', ')}
        </p>
      )}
    </div>
